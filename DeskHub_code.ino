...
const char* WIFI_SSID     = "ministrong_07";
const char* WIFI_PASS     = "Xue060810";
const char* SPOTIFY_CLIENT_ID     = "ff2dad42c98a4607a31db840dfca7473";
const char* SPOTIFY_CLIENT_SECRET = "a593520a42074e8e955f4ddb19820518";

static const float WEATHER_LAT = 35.7915f;
static const float WEATHER_LON = -78.7811f;
